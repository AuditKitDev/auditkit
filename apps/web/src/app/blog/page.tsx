      ...
      <section className="max-w-4xl mx-auto px-6 pt-16 pb-24">
        <div className="mb-12">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3 text-sm">
            <Link
              href="/signup"
              className="rounded-md bg-primary px-5 py-2.5 font-semibold text-primary-foreground transition-colors hover:bg-primary/90"
            >
              Start Free
            </Link>
            <Link
              href="/#pricing"
              className="rounded-md border border-border px-5 py-2.5 text-foreground transition-colors hover:border-primary/40"
            >
              See Pricing
            </Link>
